    ...
    try:
        ...
        if n_samples <= request.n_clusters:
            return {
                ...
                "fallback_segments": _simple_customer_segment(request.data, request.n_clusters)
            }
        ...
        # 결과 정제 (NaN/Infinity 제거)
        clean_profiles = _sanitize_for_json(profiles)
